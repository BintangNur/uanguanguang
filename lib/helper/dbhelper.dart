...
import 'package:uanguanguang/models/finance.dart';
import 'package:uanguanguang/constant/finance_type_constants.dart';
...
class DbHelper {
  ...
  void _createDb(Database db, int version) async {
    ...
    await db
        .insert("user", {'email': 'bintang@email.com', 'password': 'password'});
  }
